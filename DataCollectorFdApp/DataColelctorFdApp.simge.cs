...
namespace WearableSensorFederation
{
  ...
  {
    #region Declarations
    public WearableSensorFederation.Som.FederateSom Som;
    #endregion //Declarations
    
    #region Constructor
    public CDataColelctorFdApp() : base(RTILibraryType.HLA1516e_OpenRti)
    {
      // Create and Attach Som to federate
      Som = new WearableSensorFederation.Som.FederateSom();
      SetSom(Som);
    }
