...
{
  public class CDataCollectorHlaObject : HlaObject
  {
        #region Declarations
        // TODO: Declare your local object structure here
        public DataCollectorFdApp.CDataCollector dataCollector;
        #endregion //Declarations

        #region Constructor
        public CDataCollectorHlaObject(HlaObjectClass _type) : base(_type)
    {
            // TODO: Instantiate local data here
            // var Data = new Your_LocalData_Type();
            dataCollector = new DataCollectorFdApp.CDataCollector();
      
    }
    // Copy constructor - used in callbacks
    public CDataCollectorHlaObject(HlaObject _obj) : base(_obj)
    {
      // TODO: Instantiate local data here
      // var Data = new Your_LocalData_Type();
    }
